...
$center= $_POST["centre"];
	...
	$qry2 ="UPDATE  `registered` SET 
    `name`='$fn',`gender`='$gn',`yob`='$dob',`age`='$age',`vaccine`='$vaccine',`dose`='$dose',`centre`='$center' ";
...
$qry="SELECT * FROM `registered` ORDER BY id DESC  limit 1";
...
<!-- fullname, dob, contact, email, password, address, gender -->
		...
		<div class="form-group" id="edit">
				First name- <input type="text" name="name" class="form-control" value="<?php echo $row['name']?>">
			</div>
            <div class="form-group">
				gender- <input type="text" name="gender" class="form-control" value="<?php echo $row['gender']?>">
			</div>
            ...
            <div class="form-group">
				Age - <input type="text" name="age" class="form-control" value="<?php echo $row['age']?>" >
			</div>
			<div class="form-group">
				YOB - <input type="text" name="yob" class="form-control" value="<?php echo $row['yob']?>" >
			</div>
			...
			<div class="form-group">
			vaccine name - <input id="pass2" type="text" name="vaccine" class="form-control" value="<?php echo $row['vaccine']?>">
			</div>
			<div class="form-group">
			vaccine dose - <input id="pass2" type="text" name="dose" class="form-control" value="<?php echo $row['dose']?>">
			</div>
			<div class="form-group">
			Vaccination Center - <input id="pass2" type="text" name="centre" class="form-control" value="<?php echo $row['centre']?>">
			</div>
            <!-- <div class="form-group">
			...
			<div class="form-group">
				<input type="submit" value="Delete My details" name="del" class="btn btn-danger form-control">
			</div>
